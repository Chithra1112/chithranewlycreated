...
public class FindAPatientRecordPageClass {
	
	WebDriver driver;
	
	GeneralUtilities gl = new GeneralUtilities();

	public FindAPatientRecordPageClass(WebDriver driver) {
	...
	public void clickOnSearchByIdOrName() {
		gl.clickOnElement(searchByIdOrName);
	}
